...
var reducer = function(state, action) {
  ...
  switch(action.type) {
    case 'add_stories':
      var newComments = state.feedOne.concat([action.comment]);
      newState = Object.assign({}, state, {feedOne: newComments});
      break;
    case 'set_stories':
      newState = Object.assign({}, state, {feedOne: action.feedOne})
      break;
  }
  return newState;
}
